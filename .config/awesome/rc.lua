...
rootterm      = "sudo -i xterm"
browser       = "firefox"
filemanager   = "spacefm"
configuration = terminal .. ' -e "vim -O $HOME/.config/awesome/rc.lua $HOME/.config/awesome/themes/' ..theme.. '/theme.lua"'
...
menu_appl = {
  { "Devel",						menu_appl_devel },
  { "Internet",					menu_appl_internet },
  { "Remmina",						"remmina" },
  { "Ubuntu Software Center",	"gksu software-center" }}

mainmenu = awful.menu({ items = {
  { " awesome",			menu_main },
  { " Applications",		menu_appl },
